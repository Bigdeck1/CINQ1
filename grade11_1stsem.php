...
<table class="table table-striped table-hover">
    <tbody>
            <tr>
                <th>GRADE-11 1ST SEMESTER SUBJECTS</th>
                <th>Lesson Files</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                        <a class="dropdown-item" href="lessons/ENTREPRENEURSHIP_LESSON1_INTRODUCTION.pdf" download="ENTREPRENEURSHIP_LESSON1_INTRODUCTION.pdf"><i class="material-icons">description</i> Entrepreneurship Lesson 1</a>
                        <a class="dropdown-item" href="lessons/ENTREPRENEURSHIP_LESSON2_ACTIVITY.pdf" download="ENTREPRENEURSHIP_LESSON2_ACTIVITY.pdf"><i class="material-icons">description</i> Entrepreneurship Lesson 2</a>
                    </div>
                </div>
            </td>
            </tr>
