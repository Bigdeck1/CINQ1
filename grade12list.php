...
<body>
    <header class="ui segment animate__animated animate__fadeInDown">
        <div class="ui container card-container parallax" data-aos="fade-up" data-aos-duration="2000">
            <h1 class="ui center aligned header">Grade 12 Students</h1>
    ...
    <main class="ui container">
        <div class="ui container card-container" data-aos="fade-up" data-aos-duration="2000">
            ...
            <section id="st1a" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="0">
                ...
                <p class="description">Welcome to ST-1A content for Grade 12 students.</p>
                <a href="g12st1a.php" class="ui primary button">VIEW</a>
            </section>
            <section id="st1b" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-1B</h2>
                <p class="description">Welcome to ST-1B content for Grade 12 students.</p>
                <a href="g12st1b.php" class="ui primary button">VIEW</a>
            </section>
            <section id="st1c" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-1C</h2>
                <p class="description">Welcome to ST-1C content for Grade 12 students.</p>
                <a href="g12st1c.php" class="ui primary button">VIEW</a>
            </section>
            <section id="st1d" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-1D</h2>
                <p class="description">Welcome to ST-1D content for Grade 12 students.</p>
                <a href="g12st1d.php" class="ui primary button">VIEW</a>
            </section>
            <section id="st1e" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-2A</h2>
                <p class="description">Welcome to ST-2A content for Grade 12 students.</p>
                <a href="g12st2a.php" class="ui primary button">VIEW</a>
            </section>
             <section id="st1e" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-2B</h2>
                <p class="description">Welcome to ST-2B content for Grade 12 students.</p>
                <a href="g12st2b.php" class="ui primary button">VIEW</a>
            </section>
             <section id="st1e" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-2C</h2>
                <p class="description">Welcome to ST-2C content for Grade 12 students.</p>
                <a href="g12st2c.php" class="ui primary button">VIEW</a>
            </section>
             <section id="st1e" class="ui raised segment btn-container" data-aos="fade" data-aos-delay="200">
                <h2 class="ui header title">ST-2D</h2>
                <p class="description">Welcome to ST-2D content for Grade 12 students.</p>
                <a href="g12st2d.php" class="ui primary button">VIEW</a>
            </section>
